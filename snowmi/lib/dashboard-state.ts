...
const PM_TEMPLATE: DashboardCard[] = [
  ...
  },
  {
    ...
    type: "table",
    sql: `SELECT SALESFORCE_ACCOUNT_NAME as ACCOUNT_NAME, SUM(TOTAL_DAILY_REQUESTS) as REQUESTS FROM SNOWSCIENCE.LLM.CORTEX_CODE_ACCOUNT_DAY_FACT WHERE DS >= CURRENT_DATE - 7 GROUP BY SALESFORCE_ACCOUNT_NAME ORDER BY REQUESTS DESC LIMIT 10`,
    config: { limit: 10 },
